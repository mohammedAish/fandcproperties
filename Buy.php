...
$sql = "SELECT * FROM api_data WHERE `offering_type` = 'RS' OR `offering_type` = 'CS' limit $start_from,$num_per_page";
...
<body class="u-body u-xl-mode">
    ...
    <div class="wrapper">
        <div class="main-block" style="background: #fff url('./images/exterier.jpg') top / cover no-repeat;">
            <div class="container">
        ...
        <?php echo     '<section class="products">
                <div class="products__container">
                    <h2 class="products__main-title">Our Products</h1>
        ...
        <?php
                    ...
                    <div class="pagination custom-pagination">
                        <ul>
                            <li class="papa" style="background-color:#163F8E"><a href="Buy.php?page='.($page - 1) .'"></a></li>
                            <li class="papa active"><a href="#">'; echo $page.'</a></li>
                            <li class="papa" ><a href="Buy.php?page='.($page + 1) .'">'; echo $page + 1 .'</a></li>
                            <li class="papa"><a href="Buy.php?page='.($page + 2) .'">'; echo $page + 2 .'</a></li>
                            <li class="papa"><a href="Buy.php?page='.($page + 3) .'">'; echo $page + 3 .'</a></li>
                            <li class="papa"><a href="Buy.php?page='.($page + 4) .'">'; echo $page + 4 .'</a></li>
                            <li class="papa"><a href="Buy.php?page='.($page + 5) .'">'; echo $page + 5 .'</a></li>
                            <li class="papa" ><a href="Buy.php?page='.($page + 6) .'">'; echo $page + 6 .'</a></li>
                            <li class="papa" ><a href="Buy.php?page='.($page + 7) .'">'; echo $page + 7 .'</a></li>
                            <li class="papa"><a href="Buy.php?page='.($page + 8) .'">'; echo $page + 8 .'</a></li>
                            <li class="papa"><a href="Buy.php?page='.($page + 9) .'">'; echo $page + 9 .'</a></li>
                            <li class="papa" style="background-color:#163F8E"><a href="Buy.php?page='.($page + 1) .'"></a></li>
                        </ul>
                    </div>
                </div>';
    ...
    imagePath: 'https://developers.google.com/maps/documentation/javascript/examples/markerclusterer/m',
        ...
        <?php
		$query =  $conn->query('SELECT * FROM api_data WHERE offering_type="RS" OR offering_type="CS"');
		if ($query->num_rows > 0) {

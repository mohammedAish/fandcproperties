...
import * as Buy from "js/Files/Api/Buy.js";
...
(() => {
    ...
    (() => {
        ...
        function initSliders() {
            ...
            if (document.querySelector(".bedroom-tabs__body")) new core(".bedroom-tabs__body", {
                modules: [ Navigation, Pagination ],
                observer: true,
                observeParents: true,
                slidesPerView: 1,
                ...
                speed: 800,
                navigation: {
                    prevEl: ".bedroom-tabs__body .slider-arrow_prev",
                    nextEl: ".bedroom-tabs__body .slider-arrow_next"
                }
            });
        }
 ...
 */
        !function(t, e) {
            "function" == typeof define && define.amd ? define("jquery-bridget/jquery-bridget", [ "jquery.js" ], (function(i) {
                return e(t, i);
            })) : "object" == typeof module && module.exports ? module.exports = e(t, require("jquery.js")) : t.jQueryBridget = e(t, t.jQuery);
        }(window, (function(t, e) {
            "use strict";
            function i(i, s, a) {
                function u(t, e, o) {
        ...
        async function pageMore() {
            ...
            if ("/more.html" === location.pathname) {
                ...
                await getResource("/data_developer/");
                ...
                const bedroomTabsContent = document.querySelector(".bedroom-tabs__content");
                dataCurrentObject.object_plan.forEach(((item, index) => {
                    const button = document.createElement("button");
                    button.className = `bedroom-tabs__title tabs__title ${0 === index && "_tab-active"}`;
                ...
                fcButtonVideo.dataset.popupYoutube = match && 11 == match[7].length ? match[7] : false;
        ...
        async function pageHome() {
            document.body;
            if ("/off-Plan.html" === location.pathname) {
                const data = await getResource("/an_object/");
                const data_developer = await getResource("/data_developer/");
                data.forEach(((char, index) => {
                    ...
                    propertyItem.innerHTML = `\n        <a href="/more.html" class="item-properties__image-ibg">\n            <img src="${char.mainphoto}" alt="">\n        </a>\n        <div class="item-properties__content">\n            <div class="item-properties__body">\n                <div class="item-properties__title">${char.area}</div>\n                <div class="item-properties__subtitle">\n                    Area: <span class="item-properties__value">\n                        ${data_developer[index]?.name ? data_developer[index].name : ""}\n                    </span>\n                </div>\n                <div class="item-properties__position">\n                    <img src="./img/icons/building.svg" class="item-properties__icon" alt="Building icon">\n                    <span class="item-properties__value">Azizi</span>\n                </div>\n                <div class="item-properties__info">\n                    <a href="${char.video_link}" class="item-properties__col">\n                        <img src="./img/icons/youtube.svg" class="item-properties__icon" alt="Youtube icon">\n                        <span class="item-properties__subtitle">\n                            Play Video Overview\n                        </span>\n                    </a>\n                    <a href="${char.tour_360}" class="item-properties__col">\n                        <img src="./img/icons/360.svg" class="item-properties__icon" alt="360deg icon">\n                        <span class="item-properties__subtitle">\n                            Open 3600 Tour\n                        </span>\n                    </a>\n                </div>\n                <div class="item-properties__subtitle">\n                    from: \n                    <span class="item-properties__price">\n                        AED ${char.starting_price.toString().replace(/(\d)(?=(\d\d\d)+([^\d]|$))/g, ",")}\n                    </span>\n                </div>\n            </div>\n            <a href="/more.html#${char.id}" class="item-properties__next">\n                <span class="_icon-arrow-right"></span>\n            </a>\n        </div>`;
        ...
        function map(n) {
            ...
            function init() {
                var myMap = new ymaps.Map("map", {
                    controls: [],
                    center: [ 25.03647699554754, 55.22024899999997 ],
                    zoom: 10
                });

...
if(isset($_POST['submit']))
{
    ...
    $sql = "INSERT INTO `documents` (`id`, `name`, `category`, `description`, `doc`, `created`) VALUES (NULL, '$name', '$category', '$description', '$filename1', NOW())";
                                ...
                                <div class="card-body">        
                                    ...
                                    <form class="form-parsley" action="#" method="POST" enctype="multipart/form-data">
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="name" class="form-control" required placeholder="Document Name"/>
                                        </div><!--end form-group-->
    
                                        <div class="form-group">
                                        <h4 class="mt-0 header-title">Document Categorie</h4>
                                            <select   class="form-control" name="category" required>
                                            <option>Brochure</option>
                                            <option>MOU</option>
                                            <option>Tanancy Contract</option>
                                            </select>
                                        ...
                                        <div class="form-group">
                                        <h4 class="mt-0 header-title">Document Descriptin</h4>
                                        ...
                                        <h4 class="mt-0 header-title">Document File</h4>

...
$ag_id = $_SESSION['id'];
  $sql = "SELECT * FROM agents WHERE id='$ag_id'"; 
  $rs_result = $conn->query($sql);

  $all = "SELECT * FROM agents"; 
  $all_res = $conn->query($all);
                    ...
                    <div class="menu-body slimscroll">
                        <div id="MetricaAnalytic" class="main-icon-menu-pane">
                            ...
                            <ul class="nav">
                                ...
                                <li class="nav-item"><a class="nav-link" href="reports.php"><i class="dripicons-document"></i>Reports</a></li> 
                            </ul>
                        </div><!-- end Analytic -->
                            ...
                            echo'<div class="col-lg-3">
                                ...
                                <div class="card-body">
                                    <div class=" d-flex justify-content-between">
                                        <h4 class="header-title mt-0 d-inline-block">'.$row['agent_id'].'</h4>
                                    ...
                                    <div class="text-center">
                                        <img src="img/agents/'.$row['pic'].'" alt="" class="rounded-circle user-img img-thumbnail">
                                        <div class="online-circle">';
                                            if($row['status'] == 'Online'){ echo'<i class="fa fa-circle text-success"></i>';}
                                            elseif($row['status'] == 'Offline'){
                                                echo'<i class="fa fa-circle text-failed"></i>';
                                            }
                                        echo '</div>                                        
                                        <h4 class="team-leader">'.$row['full_name'].'</h4>
                                        <p class="text-muted font-12">'.$row['position'].'</p>

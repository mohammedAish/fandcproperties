                    ...
                    <div class="menu-body slimscroll">
                        ...
                        <div id="MetricaPages" class="main-icon-menu-pane">
                            ...
                            <ul class="nav">
                                ...
                                <li class="nav-item"><a class="nav-link" href="pages/pages-Blogs.php"><i class="dripicons-blog"></i>Blogs</a></li>
                                ...
                                <div class="card-body invoice-head"> 
                                    <div class="row">
                                        <div class="col-md-2 align-self-center">                                                
                                            <img src="assets/images/000.jpg" alt="logo-small" class="logo-sm mr-2" height="100">                                            
                                            ...
                                            <ul class="list-inline mb-0 contact-detail float-right">                                                   
                                                <li class="list-inline-item">
                                                    <div class="pl-2">
                                                        ...
                                                        <p class="text-muted mb-0">www.fandcproperties.ae</p>
                                                        <p class="text-muted mb-0">www.fcproperties.ae</p>
                                                    </div>                                                
                                                </li>
                                                <li class="list-inline-item">
                                                    <div class="pl-2">
                                                        <i class="mdi mdi-phone"></i>
                                                        <p class="text-muted mb-0">+971 58 807 0001</p>
                                                        <p class="text-muted mb-0">+971 58 807 0001</p>
                                                    </div>
                                                </li>
                                                <li class="list-inline-item">
                                                    <div class="pl-2">
                                                        ...
                                                        <p class="text-muted mb-0">Office #704, Bay Square, B13</p>
                                                        <p class="text-muted mb-0">Business Bay Dubai U.A.E</p>
                                                    </div>
                                                </li>
                                                <li class="list-inline-item">
                                                    <div class="pl-2">
                                                        <i class="mdi mdi-book-outline"></i>
                                                        <p class="text-muted mb-0">License No 847427, ORN No 23115</p>
                                                        <p class="text-muted mb-0">TRN:100497260800003</p>
                                                    </div>
                                                </li>
                                            </ul>
                                        </div>

             ...
             <div class="left-sidenav">
                <div class="main-icon-menu">
                    <nav class="nav">
                        ...
                        <a href="#MetricaEcommerce" class="nav-link leftmenu-sm-item bg-purple shadow-purple" data-toggle="tooltip-custom" data-placement="right" title="" data-original-title="Ecommerce">
                        ...
                        <a href="#MetricaCRM" class="nav-link leftmenu-sm-item bg-secondary shadow-secondary" data-toggle="tooltip-custom" data-placement="right" title="" data-original-title="CRM">
                        ...
                        <a href="#MetricaPages" class="nav-link leftmenu-sm-item bg-light shadow-light" data-toggle="tooltip-custom" data-placement="right" title="" data-original-title="Pages">
            ...
            <div class="page-content">
                                ...
                                <div class="card-body p-0">
                                    <div class="media p-3  align-items-center">                                                
                                        ...
                                        <div class="media-body ml-3 align-self-center">
                                            <h5 class="pro-title">'.$row['full_name'].'</h5>
                                            <p class="mb-2 text-muted">'.number_format(floatval($row["your_budget"])).' AED</p> 
                                            <ul class="list-inline list-unstyled profile-socials mb-0">
                                                ...
                                                <li class="list-inline-item">
                                                <a href="#" class="">'.$row['phone_number'].'</a>
                                                </li>                                                                                                                
                                            </ul>                                                                                              
                                        </div>
                ...
                ?>
                        ...
                        <div class="col-xl-8">
                            <div class="card">
                                <div class="card-body">
                                    <h5 class="mt-0">Look Like Lead</h5>
                                    <p class="text-muted mb-3">Please Fill the Below Form</p>
                                    <div class="general-label">
                                        <form class="form">
                                            
                                            <div class="form-group mb-0 row">
                                                <label class="col-md-3 my-2 control-label">Intersted in</label>
                                                <div class="col-md-9">
                                                    ...
                                                    <div class="form-check-inline my-2">
                                                        <div class="custom-control custom-checkbox">
                                                            ...
                                                            <label class="custom-control-label" for="customCheck6">Off-Plan</label>
                                                        </div>
                                                    </div>
                                                    <div class="form-check-inline my-2">
                                                        <div class="custom-control custom-checkbox">
                                                            <input type="checkbox" class="custom-control-input" id="customCheck7" data-parsley-multiple="groups" data-parsley-mincheck="2">
                                                            <label class="custom-control-label" for="customCheck7">Secondary</label>
                                                        </div>
                                                    </div>
                                            ...
                                            <hr>
                                            <div class="form-group mb-0 row">
                                                <label class="col-md-3 my-2 control-label">How many Bedrooms ?</label>
                                                <div class="col-md-9">
    
                                                    <div class="form-check-inline my-2">
                                                        <div class="custom-control custom-checkbox">
                                                            <input type="checkbox" class="custom-control-input" id="customCheck6" data-parsley-multiple="groups" data-parsley-mincheck="2">
                                                            <label class="custom-control-label" for="customCheck6">1 Bedroom</label>
                                                        </div>
                                                    </div>
                                                    <div class="form-check-inline my-2">
                                                        <div class="custom-control custom-checkbox">
                                                            <input type="checkbox" class="custom-control-input" id="customCheck7" data-parsley-multiple="groups" data-parsley-mincheck="2">
                                                            <label class="custom-control-label" for="customCheck7">2 Bedrooms</label>
                                                        </div>
                                                    </div>
                                                    <div class="form-check-inline my-2">
                                                        <div class="custom-control custom-checkbox">
                                                            <input type="checkbox" class="custom-control-input" id="customCheck7" data-parsley-multiple="groups" data-parsley-mincheck="2">
                                                            <label class="custom-control-label" for="customCheck7">3 Bedrooms</label>
                                                        </div>
                                                    </div>
                                                    <div class="form-check-inline my-2">
                                                        <div class="custom-control custom-checkbox">
                                                            <input type="checkbox" class="custom-control-input" id="customCheck7" data-parsley-multiple="groups" data-parsley-mincheck="2">
                                                            <label class="custom-control-label" for="customCheck7">4 Bedrooms</label>
                                                        </div>
                                                    </div>
                                                    <div class="form-check-inline my-2">
                                                        <div class="custom-control custom-checkbox">
                                                            <input type="checkbox" class="custom-control-input" id="customCheck7" data-parsley-multiple="groups" data-parsley-mincheck="2">
                                                            <label class="custom-control-label" for="customCheck7">5 Bedrooms</label>
                                                        </div>
                                                    </div>
                                                    <div class="form-check-inline my-2">
                                                        <div class="custom-control custom-checkbox">
                                                            <input type="checkbox" class="custom-control-input" id="customCheck7" data-parsley-multiple="groups" data-parsley-mincheck="2">
                                                            <label class="custom-control-label" for="customCheck7">6 Bedrooms</label>
                                                        </div>
                                                    </div>
                                            ...
                                            <hr>
                                            <div class="form-group mb-0 row">
                                                <label class="col-md-3 my-2 control-label">How many Bathrooms ?</label>
                                                <div class="col-md-9">
    
                                                    <div class="form-check-inline my-2">
                                                        <div class="custom-control custom-checkbox">
                                                            <input type="checkbox" class="custom-control-input" id="customCheck6" data-parsley-multiple="groups" data-parsley-mincheck="2">
                                                            <label class="custom-control-label" for="customCheck6">1 Bathroom</label>
                                                        </div>
                                                    </div>
                                                    <div class="form-check-inline my-2">
                                                        <div class="custom-control custom-checkbox">
                                                            <input type="checkbox" class="custom-control-input" id="customCheck7" data-parsley-multiple="groups" data-parsley-mincheck="2">
                                                            <label class="custom-control-label" for="customCheck7">2 Bathrooms</label>
                                                        </div>
                                                    </div>
                                                    <div class="form-check-inline my-2">
                                                        <div class="custom-control custom-checkbox">
                                                            <input type="checkbox" class="custom-control-input" id="customCheck7" data-parsley-multiple="groups" data-parsley-mincheck="2">
                                                            <label class="custom-control-label" for="customCheck7">3 Bathrooms</label>
                                                        </div>
                                                    </div>
                                                    <div class="form-check-inline my-2">
                                                        <div class="custom-control custom-checkbox">
                                                            <input type="checkbox" class="custom-control-input" id="customCheck7" data-parsley-multiple="groups" data-parsley-mincheck="2">
                                                            <label class="custom-control-label" for="customCheck7">4 Bathrooms</label>
                                                        </div>
                                                    </div>
                                                    <div class="form-check-inline my-2">
                                                        <div class="custom-control custom-checkbox">
                                                            <input type="checkbox" class="custom-control-input" id="customCheck7" data-parsley-multiple="groups" data-parsley-mincheck="2">
                                                            <label class="custom-control-label" for="customCheck7">5 Bathrooms</label>
                                                        </div>
                                                    </div>
                                                    <div class="form-check-inline my-2">
                                                        <div class="custom-control custom-checkbox">
                                                            <input type="checkbox" class="custom-control-input" id="customCheck7" data-parsley-multiple="groups" data-parsley-mincheck="2">
                                                            <label class="custom-control-label" for="customCheck7">6 Bathrooms</label>
                                                        </div>
                                                    </div>
                                            ...
                                            <div class="form-group row">
                                                <label class="col-md-3 control-label  my-2">Area</label>
                                                <div class="col-sm-9">
                                                    <select class="form-control">
                                                        ...
                                                        if ($rs_result1->num_rows > 0) {
                                                            ...
                                                            while($row1 = $rs_result1->fetch_assoc()) {
                                                                ...
                                                                echo '<option value="'.$row1['region'].'">'.$row1['region'].'</option>';
                                                ...
                                                <div class="form-group mb-0 row">
                                                <label class="col-md-3 my-2 control-label">Budget</label>
                                                <div class="col-sm-9">
                                                <input class="form-control" type="number" value="100000" id="example-number-input">
                                                </div>
                                                </div>
                                                ...
                                                <div class="form-group mb-0 row">
                                                <label class="col-md-3 my-2 control-label">Payment</label>
                                                <div class="col-sm-9">
                                                <select class="form-control">
                                                        <option>Cash</option>
                                                        <option>Cheuqe</option>
                                                </select>
                                                </div>
                                                </div>

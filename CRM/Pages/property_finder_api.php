...
<html lang="en">
    <head>
        <meta charset="utf-8" />
        <title>Property Finder API</title>
    ...
    <div class="row">
        <div class="col-sm-12">
            <div class="page-title-box">
                ...
                <h4 class="page-title">Property Finder API</h4>
                        ...
                        <div class="col-lg-12">
                            <div class="card">
                                <div class="card-body">
                                    ...
                                    <h4 class="mt-0 header-title">SEO Manager</h4>
                                    ...
                                    <div class="table-responsive">
                                        <table id="datatable" class="table table-bordered dt-responsive nowrap" style="border-collapse: collapse; border-spacing: 0; width: 100%;">
                                            ...
                                            echo '<tr>
                                                <td><img src="assets/images/users/user-3.jpg" alt="" class="rounded-circle thumb-sm mr-1">'.$row['reference_number'].'</td>
                                                <td>'.$row['offering_type'].'</td>
                                                <td>'.$row['price'].'</td>
                                                <td>'.$row['community'] .','. $row['sub_community'].'</td>
                                                <td>'.$row['title_en'].'</td>
                                                <td>'.$row['bedroom'].'</td>
                                                <td>'.$row['bathroom'].'</td>
...
<footer class="footer text-center text-sm-left">
    &copy; F & C Properties <span class="text-muted d-none d-sm-inline-block float-right">Crafted with <i class="mdi mdi-heart text-danger"></i> by Raven</span>
</footer><!--end footer-->
</div>
            <!-- end page content -->
        </div>

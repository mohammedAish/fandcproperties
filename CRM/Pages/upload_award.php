...
if(isset($_POST['submit']))
{
    ...
    $filename1 = $_FILES["awa"]["name"];
    $tempname1 = $_FILES["awa"]["tmp_name"]; 
    $folder1 = $targetDir . $filename1;

    $sql = "INSERT INTO `award` (`id`, `name`, `agent_name`, `description`, `awa`, `created`) VALUES (NULL, '$name', '$agent', '$description', '$filename1', NOW())";
            ...
            <div class="page-content">
                ...
                <div class="container-fluid">
                    ...
                    <div class="col-lg-12">
                            <div class="card">
                                <div class="card-body">        
                                    <h4 class="mt-0 header-title">Award info</h4>
                                    <form class="form-parsley" action="#" method="POST" enctype="multipart/form-data">
                                        <div class="form-group">
                                            <label>Award Name</label>
                                            <input type="text" name="name" class="form-control" required placeholder="Award Name"/>
                                        </div><!--end form-group-->
    
                                        <div class="form-group">
                                        <h4 class="mt-0 header-title">Choose Agent</h4>
                                            ...
                                            echo'<option value="'.$row['agent_id'].'">'.$row['full_name'].'</option>';
                                        }
                                    } else {
                                        echo "0 results";
                                    }
                                    ...
                                    ?>
                                        ...
                                        <div class="form-group">
                                        <h4 class="mt-0 header-title">Award Descriptin</h4>
                                        ...
                                        <h4 class="mt-0 header-title">Award Proof</h4>
                                            <p class="text-muted mb-3">PDF , CSV , PNG , JPG , PSD , MP3 , MP4 , etc</p>
                                        <input type="file" name="awa" id="input-file-now" class="dropify" />                                                   
                                        
                                        </div><!--end form-group-->

                                        <div class="form-group mb-0">
                                            <button type="submit" name="submit" class="btn btn-gradient-primary waves-effect waves-light">
                                                Submit
                                            </button>
